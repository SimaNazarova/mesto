import "./index.css";
import  {objSet, profileEditButton, popupAddPhotoButton,
formName, formJob, profileAvatar, popupAvatarOpen, cardListSelector} from '../utils.js/constants.js';
...
popupAddPhotoButton.addEventListener('click', () => { //кнопка открыть попап с формой добавления фото
...
profileEditButton.addEventListener('click', () => { // кнопка открыть попап с формой редактирования профайла
...
popupAvatarOpen.addEventListener('click',() => { // // кнопка открыть попап с формой добавления фото
